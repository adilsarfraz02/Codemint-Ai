...
const Sidebar = () => {
  ...
  return (
    <div className='h-[94vh] bg-zinc-500/10 backdrop-blur-lg rounded-3xl p-4 w-1/4'>
      ...
      <div className="mx-20 mt-2">
        <button className={`w-full py-2 rounded-3xl transition active:bg-purple-500 focus:bg-purple-500 hover:bg-purple-500 bg-pink-500 ${loading ? 'opacity-20 cursor-not-allowed' : ''}`}  onClick={()=>{signOut(); setLoading(true)}}>Logout</button>
      </div>
    </div>
  )
}
