  ...
  return ( 
    <>
      {/* <div className='bg overflow-hidden -z-10 right-0 fixed bg-gradient-to-t from-purple-500 via-purple-500 to-blue-800 rounded-full'></div> */}
        ...
        <nav className='flex sidebar border-b dark:border-gray-200/20 border-zinc-600/40 max-md:px-5 max-sm:px-7 justify-between max-sm:gap-12 py-5 px-12 backdrop-blur-md '>
            ...
            <div className='ml-12 text-center max-md:hidden transition delay-75 mt-4 max-sm:m-0 max-sm:hidden max-md:ml-6'> 
              <ul className='flex mt-2 max-md:gap-8 gap-3 max-sm:4'>
                <li className={`p-3 hover:bg-gray-300 rounded-xl backdrop-blur-x px-7 transition delay-75 hover:text-pink-500/80 ${pathname === '/tools' ? 'text-pink-500 bg-purple-500/10 rounded-2xl' : ''}`} title='Tools'>
                  <Link href="/tools" legacyBehavior>
                      Tools
                  </Link>
                  </li>
                <li className={`p-3 backdrop-blur-x hover:bg-gray-300 rounded-xl transition delay-75 px-7 hover:text-pink-500/80 ${pathname === '/blogs' ? 'text-pink-500 bg-purple-500/10 rounded-2xl' : ''}`} title='Blogs'>
            ...
            <div className='py-5 max-md:hidden flex'>
